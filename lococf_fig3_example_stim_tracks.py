...
path_save = 'J:\\LocoCF\\Fig3 - split stance stim jaws\\'
path = 'J:\\Opto JAWS Data\\split right fast stance stim\\'
...
for r in range(np.shape(led_trials)[1]):
    rectangle = plt.Rectangle((timestamps_session[trial - 1][led_trials[0, r]], 120),
                              timestamps_session[trial - 1][led_trials[1, r]] - timestamps_session[trial - 1][led_trials[0, r]], 150, fc='lightblue', alpha=0.3, zorder=0)
...
plt.savefig(os.path.join(path_save, 'fig3_stance_stim_example_MC17670_trial9_40,9_41,53s.png'), dpi=256)
plt.savefig(os.path.join(path_save, 'fig3_stance_stim_example_MC17670_trial9_40,9_41,53s.svg'), dpi=256)