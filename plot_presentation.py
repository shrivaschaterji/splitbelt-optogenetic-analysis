...
for i in trials[:12]-1:
    ax.scatter(0.5+np.random.rand(), accuracy_st[i], color='green')
    ax.scatter(2.5+np.random.rand(), accuracy_sw[i], color='orange')
    if i == 10 or i == 11:
        ax.scatter(0.5 + np.random.rand(), accuracy_st[i], color='darkgrey')
        ax.scatter(2.5 + np.random.rand(), accuracy_sw[i], color='darkgrey')
for i in trials[12:]-1:
    ax.scatter(4.5+np.random.rand(), accuracy_st[i], color='green')
    ax.scatter(6.5+np.random.rand(), accuracy_sw[i], color='orange')
    if i == 22 or i == 23:
        ax.scatter(4.5 + np.random.rand(), accuracy_st[i], color='darkgrey')
        ax.scatter(6.5 + np.random.rand(), accuracy_sw[i], color='darkgrey')
ax.bar(1, np.nanmean(accuracy_st[trials[:12]-1]), color='green', zorder=0, alpha=0.7)
ax.bar(3, np.nanmean(accuracy_sw[trials[:12]-1]), color='orange', zorder=0, alpha=0.7)
ax.bar(5, np.nanmean(accuracy_st[trials[12:]-1]), color='green', zorder=0, alpha=0.7)
ax.bar(7, np.nanmean(accuracy_sw[trials[12:]-1]), color='orange', zorder=0, alpha=0.7)
...
fig, ax = plt.subplots(tight_layout=True, figsize=(10,7))
for i in trials[:12]-1:
    ax.scatter(0.5+np.random.rand(), f1_st[i], color='green')
    ax.scatter(2.5+np.random.rand(), f1_sw[i], color='orange')
    if i == 10 or i == 11:
        ax.scatter(0.5 + np.random.rand(), f1_st[i], color='darkgrey')
        ax.scatter(2.5 + np.random.rand(), f1_sw[i], color='darkgrey')
for i in trials[12:]-1:
    ax.scatter(4.5+np.random.rand(), f1_st[i], color='green')
    ax.scatter(6.5+np.random.rand(), f1_sw[i], color='orange')
    if i == 22 or i == 23:
        ax.scatter(4.5 + np.random.rand(), f1_st[i], color='darkgrey')
        ax.scatter(6.5 + np.random.rand(), f1_sw[i], color='darkgrey')
ax.bar(1, np.nanmean(f1_st[trials[:12]-1]), color='green', zorder=0, alpha=0.7)
ax.bar(3, np.nanmean(f1_sw[trials[:12]-1]), color='orange', zorder=0, alpha=0.7)
ax.bar(5, np.nanmean(f1_st[trials[12:]-1]), color='green', zorder=0, alpha=0.7)
ax.bar(7, np.nanmean(f1_sw[trials[12:]-1]), color='orange', zorder=0, alpha=0.7)
ax.set_xticks([1, 3, 5, 7])
ax.set_xticklabels(['stance wide', 'swing wide', 'stance narrow', 'swing narrow'])
...
for count_t, trial in enumerate(trials):
    ...
    ax.bar(trials, [np.shape(offtracks_st.loc[offtracks_st['trial']==i])[0] for i in trials]-np.array(otrack_st_hits), bottom = np.array(otrack_st_hits), color='darkolivegreen')
...
plt.gca().add_patch(rectangle2)
for count_t, trial in enumerate(trials):
    ax.bar(trials, np.array(otrack_sw_hits), color='orange')
    ax.bar(trials,
              [np.shape(offtracks_sw.loc[offtracks_sw['trial'] == i])[0] for i in trials] - np.array(otrack_sw_hits),
              bottom = np.array(otrack_sw_hits), color='goldenrod')
ax.set_xlabel('Trials', fontsize=16)
...
fig, ax = plt.subplots(tight_layout=True, figsize=(10,7))
for i in trials[:12]-1:
    ax.scatter(0.5+np.random.rand(), tp_st_laser[i] + tn_st_laser[i], color='green')
    ax.scatter(2.5+np.random.rand(), tp_sw_laser[i] + tn_sw_laser[i], color='orange')
    if i == 10 or i == 11:
...
for i in trials[12:]-1:
    ax.scatter(4.5+np.random.rand(), tp_st_laser[i] + tn_st_laser[i], color='green')
    ax.scatter(6.5+np.random.rand(), tp_sw_laser[i] + tn_sw_laser[i], color='orange')
    if i == 22 or i == 23:
...
ax.bar(1, np.nanmean(tp_st_laser[trials[:12]-1]+tn_st_laser[trials[:12]-1]), color='green', zorder=0, alpha=0.7)
ax.bar(3, np.nanmean(tp_sw_laser[trials[:12]-1]+tn_sw_laser[trials[:12]-1]), color='orange', zorder=0, alpha=0.7)
ax.bar(5, np.nanmean(tp_st_laser[trials[12:]-1]+tn_st_laser[trials[12:]-1]), color='green', zorder=0, alpha=0.7)
ax.bar(7, np.nanmean(tp_sw_laser[trials[12:]-1]+tn_sw_laser[trials[12:]-1]), color='orange', zorder=0, alpha=0.7)
ax.set_xticks([1, 3, 5, 7])
ax.set_xticklabels(['stance wide', 'swing wide', 'stance narrow', 'swing narrow'])
ax.set_ylabel('Accuracy (%)', fontsize=16)
plt.xticks(fontsize=16)
...
fig, ax = plt.subplots(tight_layout=True, figsize=(10,7))
for i in trials[:12]-1:
    ax.scatter(0.5+np.random.rand(), f1_st_laser[i], color='green')
    ax.scatter(2.5+np.random.rand(), f1_sw_laser[i], color='orange')
    if i == 10 or i == 11:
        ax.scatter(0.5 + np.random.rand(), f1_st_laser[i], color='darkgrey')
        ax.scatter(2.5 + np.random.rand(), f1_sw_laser[i], color='darkgrey')
for i in trials[12:]-1:
    ax.scatter(4.5+np.random.rand(), f1_st_laser[i], color='green')
    ax.scatter(6.5+np.random.rand(), f1_sw_laser[i], color='orange')
    if i == 22 or i == 23:
        ax.scatter(4.5 + np.random.rand(), f1_st_laser[i], color='darkgrey')
        ax.scatter(6.5 + np.random.rand(), f1_sw_laser[i], color='darkgrey')
ax.bar(1, np.nanmean(f1_st_laser[trials[:12]-1]), color='green', zorder=0, alpha=0.7)
ax.bar(3, np.nanmean(f1_sw_laser[trials[:12]-1]), color='orange', zorder=0, alpha=0.7)
ax.bar(5, np.nanmean(f1_st_laser[trials[12:]-1]), color='green', zorder=0, alpha=0.7)
ax.bar(7, np.nanmean(f1_sw_laser[trials[12:]-1]), color='orange', zorder=0, alpha=0.7)
ax.set_xticks([1, 3, 5, 7])
ax.set_xticklabels(['stance wide', 'swing wide', 'stance narrow', 'swing narrow'])
