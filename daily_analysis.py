...
# Inputs
laser_event = 'stance'
path = 'C:\\Users\\Ana\\Documents\\PhD\\Online Tracking Treadmill\\Experiments\\31032023 stance wide stim\\MC16851\\'
animal = 'MC16851'
session = 1
Ntrials = 24
stim_start = 9
...
# fig, ax = plt.subplots(figsize=(7, 10), tight_layout=True)
# rectangle = plt.Rectangle((stim_start - 0.5, min(param_sym_bs_sl[:, :].flatten())), stim_duration,
#                           max(param_sym_bs_sl[:, :].flatten()) - min(param_sym_bs_sl[:, :].flatten()),
#                           fc='dimgrey', alpha=0.3)
# plt.gca().add_patch(rectangle)
