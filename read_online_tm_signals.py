...
paw_otrack = 'FR'
# path_main = 'I:\\'
# subdir = 'test sync pulse 200323\\'
path_main = 'G:\\My Drive\\BACKUP\\TM closed loop tracking\\Tests\\learning and threshold tests 140323\\'
...
[camera_frames_kept, camera_frame_counter_session] = otrack_class.get_session_metadata(plot_data)
